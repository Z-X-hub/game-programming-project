...
- [ ] Stage 2: organise and upload Unity project source under `final-project`.
- [ ] Stage 2: confirm the main playable scene and build/run instructions.

## To Do

- [ ] Stage 2: record character selection and gameplay systems as development evidence.
